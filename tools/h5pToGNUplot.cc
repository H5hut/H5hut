...
int main(int argc, const char *argv[])
{
  ...
  if(var_1 == NULL || var_2 == NULL || timestep == NULL)
   ...
   for (; j<ntime_step; j++)
   {
      ...
      {
         value_1 = (long long int*)malloc(sizeof(long long int)*nparticles);
         H5PartReadDataInt64(h5file, var_1, (long long int*)value_1);
      }
      ...
      {
         value_2 = (long long int*)malloc(sizeof(long long int)*nparticles);
         H5PartReadDataInt64(h5file, var_2, (long long int*)value_2);
      }
     ...
     if(output_name != NULL)
     {
       ...
       {
          if (type_1 == H5T_NATIVE_INT64)
            fprintf(outFile, "%ld", ((long long int*)value_1)[i]);
          else if (type_1 == H5T_NATIVE_DOUBLE)
            fprintf(outFile, "%lf", ((double*)value_1)[i]);

          if (type_2 == H5T_NATIVE_INT64)
            fprintf(outFile, "\t%ld", ((long long int*)value_2)[i]);
          else if (type_2 == H5T_NATIVE_DOUBLE)
     ...
     else
     {
       ...
       {
          if (type_1 == H5T_NATIVE_INT64)
            fprintf(stdout, "%ld", ((long long int*)value_1)[i]);
          else if (type_1 == H5T_NATIVE_DOUBLE)
            fprintf(stdout, "%lf", ((double*)value_1)[i]);

          if (type_2 == H5T_NATIVE_INT64)
            fprintf(stdout, "\t%ld", ((long long int*)value_2)[i]);
          else if (type_2 == H5T_NATIVE_DOUBLE)
